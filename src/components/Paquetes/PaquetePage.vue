    ...
    <v-row v-if="paquete && paquete.codigo">
        <v-col cols="12" md="7">
            ...
            <v-row v-if="paquete.fechas && paquete.fechas.length" no-gutters
                ...
                <v-col cols="12" md="6" v-for="fecha in paquete.fechas" :key="fecha.id" class="p-2">
                    <h5 for="fechas" class="fs-4 bborder-bottom border-white d-flex align-items-center">
                        <i class="fa fa-circle me-2" style="font-size: 8px;"></i> {{ mes(fecha.fecha) }}
                    </h5>
            ...
            <v-row v-if="paquete.alojamientos && paquete.alojamientos.length" no-gutters
                ...
                <v-col cols="12" md="12" v-for="alojamiento in paquete.alojamientos" :key="alojamiento.id" class="p-2">
                    <h5 for="alojamiento" class="fs-4 bborder-bottom border-white d-flex align-items-center">
                        <i class="fa fa-circle me-2" style="font-size: 8px;"></i> {{ alojamiento.alojamiento }}
                    </h5>
                    <!-- <div class="d-flex align-items-center justify-content-between">
                        <span>Tarifa:</span>
                        <span>
